# Wrapper for run_asr_batch.py -- evaluates ASR for every checkpoint produced
# by generate_perturbed_checkpoints.sh, plus the original poisoned checkpoint
# as a baseline, and compiles everything into one CSV
# (asr_batch_results/<tag>/asr_results.csv).
...
results_dir=asr_batch_results/${model_name_key}-${p_type}-${quantize_method}
...
echo "=========================================="
echo -e "\nRunning ASR batch eval for ${manifest} (+ baseline checkpoint) ...\n"
echo "  results_dir: ${results_dir}"
echo "=========================================="

CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python run_asr_batch.py \
    --manifest ${manifest} \
...
echo "=========================================="
echo -e "\nDone. Results in ${results_dir}/asr_results.csv\n"
echo "=========================================="
